    ...
    <div class="card-body">
        <table class="table table-borderless table-sm mb-3">
            <tbody>
                ...
                $where      = " WHERE (point_type != 0) AND (point_member = $member_id) ";

                if ($action == 'search') {

                    if ($point_type != 'all') { $where = " WHERE (point_type = '$point_type') AND (point_member = $member_id) "; }
        ...
        <?php 
        $url = "member.php?page=commission_list&action=search&date_start=$date_start&date_end=$date_end&point_type=$point_type";
    ...
    <div class="switcher-body">
        ...
        <form action="" method="get" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="member.php?page=commission_list" class="btn btn-secondary btn-sm"><?php echo $l_cancel ?></a>
            </div>
        </form>
    </div>
</div>