...
--
-- Host: localhost
-- Generation Time: May 09, 2022 at 05:58 AM
...
CREATE TABLE `system_address` (
  ...
  `address_member` int(11) NOT NULL COMMENT 'ไอดีสมาชิก',
  `address_detail` varchar(100) DEFAULT NULL COMMENT 'ที่อยู่',
  `address_district` varchar(30) DEFAULT NULL COMMENT 'ตำบล',
  `address_amphure` varchar(30) DEFAULT NULL COMMENT 'อำเภอ',
  `address_province` varchar(30) DEFAULT NULL COMMENT 'จังหวัด',
  `address_zipcode` varchar(5) DEFAULT NULL COMMENT 'รหัสไปรษณีย์',
  `address_type` int(11) NOT NULL DEFAULT '0' COMMENT '0=default, 1=จัดส่งสินค้า'
...
CREATE TABLE `system_admin` (
  ...
  `admin_user` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `admin_pass` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `admin_lang` int(11) NOT NULL DEFAULT '0' COMMENT '0=TH,1=ENG',
  `admin_status` int(1) NOT NULL COMMENT '0=programer,1=admin'
...
INSERT INTO `system_admin` (`admin_id`, `admin_name`, `admin_user`, `admin_pass`, `admin_lang`, `admin_status`) VALUES
(1, 'programer', 'programer', '1234', 1, 0),
(2, 'manager', 'manager', '1234', 0, 1),
(3, 'admin', 'admin', '1234', 0, 2),
(4, 'actadmin', 'actadmin', '1234', 0, 3);

-- --------------------------------------------------------

--
-- Table structure for table `system_amphures`
--

CREATE TABLE `system_amphures` (
  `AMPHUR_ID` int(11) NOT NULL,
  `AMPHUR_CODE` varchar(4) COLLATE utf8_bin NOT NULL,
  `AMPHUR_NAME` varchar(150) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `system_amphures`
--

INSERT INTO `system_amphures` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
CREATE TABLE `system_bank` (
  ...
  `bank_acr` varchar(10) NOT NULL,
  `bank_name_th` varchar(30) NOT NULL,
  `bank_name_eng` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_bank`
--

INSERT INTO `system_bank` (`bank_id`, `bank_code`, `bank_acr`, `bank_name_th`, `bank_name_eng`) VALUES
(1, '002', 'BBL', 'ธนาคารกรุงเทพ', NULL),
(2, '004', 'KBANK', 'ธนาคารกสิกรไทย', NULL),
(3, '006', 'KTB', 'ธนาคารกรุงไทย', NULL),
(4, '011', 'TTB', 'ธนาคารทหารไทยธนชาติ', NULL),
(5, '014', 'SCB', 'ธนาคารไทยพาณิชย', NULL),
(6, '025', 'BAY', 'ธนาคารกรุงศรีอยุธยา', NULL),
(7, '069', 'KKP', 'ธนาคารเกียรตินาคินภัทร', NULL),
(8, '022', 'CIMBT', 'ธนาคารซีไอเอ็มบีไทย', NULL),
(9, '067', 'TISCO', 'ธนาคารทิสโก้\r\n', NULL),
(10, '024', 'UOBT', 'ธนาคารยูโอบี', NULL),
(11, '071', 'TCD', 'ธนาคารไทยเครดิตเพื่อรายย่อย', NULL),
(12, '073', 'LHFG', 'ธนาคารแลนด์ แอนด์ เฮ้าส', NULL),
(13, '070', 'ICBCT', 'ธนาคารไอซีบีซี (ไทย)', NULL),
(14, '098', 'SME', 'ธนาคารพัฒนาวิสาหกิจขนาดกลางและ', NULL),
(15, '034', 'BAAC', 'ธนาคารเพื่อการเกษตรและสหกรณ์กา', NULL),
(16, '035', 'EXIM', 'ธนาคารเพื่อการส่งออกและนำเข้าแ', NULL),
(17, '030', 'GSB', 'ธนาคารออมสิน', NULL),
(18, '033', 'GHB', 'ธนาคารอาคารสงเคราะห์\r\n', NULL),
(19, '066', 'ISBT', 'ธนาคารอิสลามแห่งประเทศไทย', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `system_buyer`
--

CREATE TABLE `system_buyer` (
  `buyer_id` int(11) NOT NULL,
  `buyer_direct` int(11) NOT NULL DEFAULT '1' COMMENT 'ไอดีผู้แนะนำ',
  `buyer_name` varchar(100) NOT NULL,
  `buyer_tel` varchar(10) NOT NULL,
  `buyer_email` varchar(50) NOT NULL,
  `buyer_pass` varchar(20) NOT NULL,
  `buyer_address` varchar(100) NOT NULL,
  `buyer_district` varchar(50) NOT NULL,
  `buyer_amphure` varchar(50) NOT NULL,
  `buyer_province` varchar(50) NOT NULL,
  `buyer_zipcode` varchar(5) NOT NULL,
  `buyer_status` int(11) NOT NULL DEFAULT '0' COMMENT '0=default,1=ban',
  `buyer_lang` int(11) NOT NULL,
  `buyer_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_cart`
--

CREATE TABLE `system_cart` (
  `cart_id` int(11) NOT NULL COMMENT 'ไอดี',
  `cart_member_id` int(11) NOT NULL COMMENT 'ไอดีสมาชิก',
  `cart_product_id` int(11) NOT NULL COMMENT 'ไอดีสินค้า',
  `cart_product_amount` int(11) NOT NULL DEFAULT '1' COMMENT 'จำนวนสินค้า',
  `cart_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `system_class` (
  ...
  `class_up_level` int(11) NOT NULL,
  `class_image` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `class_match_level` int(11) NOT NULL,
  `class_com` float NOT NULL DEFAULT '0' COMMENT 'คอมมิชชั่นประจำตำแหน่ง'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `system_class`
--
...
CREATE TABLE `system_comment` (
  ...
  `comment_direct` int(11) DEFAULT '0' COMMENT 'ไอดีข้อความที่ตอบกลับ',
  `comment_member` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีสมาชิก',
  `comment_buyer` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีของสมาชิกหน้าเว็บเพจ',
  `comment_type` int(11) NOT NULL DEFAULT '0' COMMENT '0=product, 1=blog',
  `comment_link` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีของสินค้าหรือบล๊อก',
  `comment_name` varchar(100) NOT NULL COMMENT 'ชื่อผู้ที่คอมเม้น',
  `comment_detail` text NOT NULL COMMENT 'รายละเอียด',
  `comment_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง',
  `comment_status` int(11) NOT NULL DEFAULT '0' COMMENT '0=notread,1=read',
  `comment_image1` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `system_commission` (
  ...
  `commission_name` varchar(50) NOT NULL COMMENT 'ลำดับชั้น',
  `commission_point` float NOT NULL DEFAULT '0' COMMENT 'เปอร์เซ็นต์โบนัส',
  `commission_point2` float NOT NULL DEFAULT '0' COMMENT 'โบนัสพิเศษ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_commission`
--

INSERT INTO `system_commission` (`commission_id`, `commission_name`, `commission_point`, `commission_point2`) VALUES
(1, 'ชั้นที่ 1', 5, 10),
(2, 'ชั้นที่ 2', 0, 0),
(3, 'ชั้นที่ 3', 0, 0),
(4, 'ชั้นที่ 4', 0, 0),
...
(8, 'com_number', 'จำนวนชั้นเงินปันผล', 4),
(9, 'com_style', 'รูปแบบการรักษายอด', 0),
(10, 'system_style', 'ประเภทของระบบ', 2),
...
(18, 'system_admin_buy', 'ระบบการซื้อด่วนของแอดมิน', 1),
...
(23, 'system_liner2', 'ระบบคอมมิชชั่นพิเศษ', 1),
...
CREATE TABLE `system_contact` (
  `contact_id` int(11) NOT NULL COMMENT 'ไอดี',
  `contact_member` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีสมาชิก',
  `contact_buyer` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีสมาชิกหน้าเว็บเพจ',
  `contact_title` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'หัวข้อ',
  `contact_name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ชื่อผู้ส่ง',
  `contact_email` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อีเมล',
  `contact_detail` text COLLATE utf8_unicode_ci COMMENT 'รายละเอียด',
  `contact_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง',
  `contact_type` int(11) NOT NULL DEFAULT '0' COMMENT '0=default, 1=admin, 2=visitor, 3=system',
  `contact_status` int(11) NOT NULL DEFAULT '0' COMMENT '0=default, 1=read'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `system_deposit`
--

CREATE TABLE `system_deposit` (
  `deposit_id` int(11) NOT NULL COMMENT 'ไอดี',
  `deposit_member` int(11) NOT NULL COMMENT 'ไอดีสมาชิก',
  `deposit_bank` varchar(100) DEFAULT NULL COMMENT 'ธนาคาร',
  `deposit_money` float NOT NULL COMMENT 'จำนวนเงิน',
  `deposit_date` varchar(20) DEFAULT NULL COMMENT 'วันที่โอน',
  `deposit_time` varchar(20) DEFAULT NULL COMMENT 'เวลาที่โอน',
  `deposit_slip` varchar(200) DEFAULT NULL COMMENT 'รูปสลิป',
  `deposit_detail` text COMMENT 'รายละเอียด',
  `deposit_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง',
  `deposit_status` int(11) NOT NULL DEFAULT '0' COMMENT '0=waiting,1=success,2=cancle,3=by admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_districts`
--
...
--
-- Dumping data for table `system_districts`
--

INSERT INTO `system_districts` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
CREATE TABLE `system_liner` (
  `liner_id` int(7) NOT NULL,
  `liner_member` int(7) NOT NULL COMMENT 'มาจาก member_id',
  `liner_direct` int(7) NOT NULL DEFAULT '0' COMMENT 'แม่ข่าย มากจาก liner_id',
  `liner_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สมัคร',
  `liner_expire` date NOT NULL COMMENT 'วันหมดอายุ',
  `liner_count` int(11) NOT NULL DEFAULT '0' COMMENT 'สมาชิกทั้งหมด',
  `liner_count_day` int(11) NOT NULL DEFAULT '0' COMMENT 'สมาชิกที่เพิ่มในวันนี้',
  `liner_count_month` int(11) NOT NULL DEFAULT '0' COMMENT 'สมาชิกที่เพิ่มในเดือนนี้',
  `liner_status` int(11) NOT NULL DEFAULT '0' COMMENT 'สถานะการรับคอมมิชชัน 0=ไม่ได้รับ, 1=ได้รับ',
  `liner_point` float NOT NULL DEFAULT '0' COMMENT 'คะแนนโบนัส',
  `liner_type` int(11) NOT NULL DEFAULT '0' COMMENT 'สถานะการเป็น vip 0=ธรรมดา, 1=VIP',
  `liner_etc` float NOT NULL DEFAULT '0' COMMENT 'เก็บค่าอื่นๆ',
  `liner_etc2` float NOT NULL DEFAULT '0' COMMENT 'เก็บค่าอื่นๆ2'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `system_liner` (`liner_id`, `liner_member`, `liner_direct`, `liner_create`, `liner_expire`, `liner_count`, `liner_count_day`, `liner_count_month`, `liner_status`, `liner_point`, `liner_type`, `liner_etc`, `liner_etc2`) VALUES
(1, 1, 0, '2022-05-13 09:27:53', '0000-00-00', 1, 0, 0, 0, 136.125, 0, 0, 0),
(2, 2, 1, '2022-05-12 17:00:00', '2022-08-06', 0, 0, 0, 1, 1113.75, 0, 15, 0);

-- --------------------------------------------------------

--
-- Table structure for table `system_liner2`
--

CREATE TABLE `system_liner2` (
  `liner2_id` int(11) NOT NULL COMMENT 'ไอดี',
  `liner2_code` varchar(20) NOT NULL DEFAULT '0' COMMENT 'รหัสสมาชิกในผัง',
  `liner2_member` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีสมาชิก',
  `liner2_direct` int(11) NOT NULL DEFAULT '0' COMMENT 'from liner_id',
  `liner2_downline` int(11) NOT NULL DEFAULT '0' COMMENT 'จำนวนสมาชิกลูกข่ายชั้นแรก',
  `liner2_count` int(11) NOT NULL DEFAULT '0' COMMENT 'จำนวนสมาชิกทั้งหมด',
  `liner2_sp_count` int(11) NOT NULL DEFAULT '0' COMMENT 'จำนวนสมาชิกที่เป็น sp',
  `liner2_type` int(11) NOT NULL DEFAULT '0' COMMENT '0=member, 1=support code',
  `liner2_class` int(11) NOT NULL DEFAULT '1' COMMENT 'หมายเลขชั้น',
  `liner2_position` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=default, 1=vip',
  `liner2_status` int(11) NOT NULL DEFAULT '1' COMMENT '0=not pass,1=pass, 2=get bonus before 16th',
  `liner2_point` float NOT NULL DEFAULT '0' COMMENT 'ค่าคอมมิชชั่น',
  `liner2_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `system_log` (
  ...
  `log_data1` varchar(100) DEFAULT NULL,
  `log_data2` varchar(100) DEFAULT NULL,
  `log_data3` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `system_log_payment`
--

CREATE TABLE `system_log_payment` (
  `payment_id` int(11) NOT NULL,
  `payment_resp_code` varchar(20) DEFAULT NULL,
  `payment_resp_msg` varchar(250) DEFAULT NULL,
  `payment_command` varchar(250) DEFAULT NULL,
  `payment_bank_ref` varchar(250) DEFAULT NULL,
  `payment_tranx_id` varchar(250) DEFAULT NULL,
  `payment_one2pay_ref` varchar(250) DEFAULT NULL,
  `payment_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `payment_effdate` varchar(250) DEFAULT NULL,
  `payment_amount` float DEFAULT NULL,
  `payment_cusname` varchar(100) DEFAULT NULL,
  `payment_ref1` varchar(250) DEFAULT NULL,
  `payment_ref2` varchar(250) DEFAULT NULL,
  `payment_ref3` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_log_withdraw`
--

CREATE TABLE `system_log_withdraw` (
  `logwd_id` int(11) NOT NULL,
  `logwd_status` varchar(10) DEFAULT NULL,
  `logwd_message` varchar(50) DEFAULT NULL,
  `logwd_member` int(11) DEFAULT NULL,
  `logwd_money` float DEFAULT NULL,
  `logwd_payout_ref` varchar(100) DEFAULT NULL,
  `logwd_transaction_id` varchar(100) DEFAULT NULL,
  `logwd_transactionDate_time` varchar(100) DEFAULT NULL,
  `logwd_qrstring` varchar(250) DEFAULT NULL,
  `logwd_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_log_withdraw`
--

INSERT INTO `system_log_withdraw` (`logwd_id`, `logwd_status`, `logwd_message`, `logwd_member`, `logwd_money`, `logwd_payout_ref`, `logwd_transaction_id`, `logwd_transactionDate_time`, `logwd_qrstring`, `logwd_create`) VALUES
(1, '-1004', 'Invalid payout config', NULL, NULL, '', '', '', '', '2022-04-30 04:33:38'),
(2, '-1004', 'Invalid payout config', 1, 0, '', '', '', '', '2022-04-30 04:36:30'),
(3, '-1004', 'Invalid payout config', 1, 0, '', '', '', '', '2022-04-30 04:38:00'),
(4, '-1004', 'Invalid payout config', 1, 343, '', '', '', '', '2022-04-30 04:39:48'),
(5, '-1004', 'Invalid payout config', 1, 343, '', '', '', '', '2022-04-30 04:48:03');
...
CREATE TABLE `system_member` (
  ...
  `member_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสสมาชิก',
  `member_email` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'อีเมล',
  `member_pass` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT 'พาสเวิร์ด',
  `member_title_name` char(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'คำนำหน้าชื่อ',
  `member_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อ-สกุล',
  `member_user` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสล๊อกอินเข้าระบบ',
  `member_tel` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'เบอร์โทรฯ',
  `member_create` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สมัคร',
  `member_bank_own` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'เจ้าของบัญชี',
  `member_bank_name` int(11) NOT NULL DEFAULT '0' COMMENT 'ธนาคาร',
  `member_bank_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสบัญชี',
  `member_class` int(2) NOT NULL DEFAULT '1' COMMENT 'ตำแหน่งในระบบ',
  `member_code_id` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'บัตรประชาชน',
  `member_point` float DEFAULT '0' COMMENT 'คะแนนรวมทั้งหมด',
  `member_point_month` float NOT NULL DEFAULT '0' COMMENT 'คะแนนรักษายอดในเดือนนี้',
  `member_month` int(11) NOT NULL DEFAULT '1' COMMENT 'จำนวนเดือนของ user',
  `member_ewallet` int(11) NOT NULL DEFAULT '0' COMMENT 'เงินในกระเป๋าเงิน',
  `member_token_line` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ไลน์โทเค่น',
  `member_status` int(1) NOT NULL DEFAULT '0' COMMENT 'สถานะ 0=ธรรมดา,1=ถูกลบ',
  `member_image_cover` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปโปรไฟล์',
  `member_image_card` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปบัตรประชาชน',
  `member_image_bank` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปบัญชีธนาคาร',
  `member_lang` int(11) NOT NULL DEFAULT '0' COMMENT '0=TH,1=ENG'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '0000001', '', '1234', NULL, 'member', 'member', '', '2022-05-05 09:27:53', '', 0, '', 1, NULL, 0, 13942.5, 2, 0, NULL, 0, NULL, NULL, NULL, 0),
(2, '0000002', '', '403124', '', 'น้ำใส', '0000002', '', '2022-05-06 11:14:02', '', 0, '', 2, '1509969403124', 0, 15551.2, 2, 0, '', 0, NULL, NULL, NULL, 0);
...
CREATE TABLE `system_order` (
  ...
  `order_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสรายการสั่งซื้อ',
  `order_member` int(11) NOT NULL DEFAULT '0' COMMENT 'สมาชิกที่ซื้อสินค้า',
  `order_buyer_id` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีของผู้ซื้อที่ซื้อหน้าเว็บเพจ',
  `order_buyer` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ชื่อของคนสั่งสินค้า',
  `order_buyer_tel` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'เบอร์โทร',
  `order_buyer_email` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อีเมล',
  `order_amount` int(11) NOT NULL COMMENT 'จำนวน',
  `order_price` float NOT NULL COMMENT 'ราคาที่ต้องชำระเงิน (รวมค่าขนส่งแล้ว)',
  `order_point` float NOT NULL COMMENT 'คะแนนรวม',
  `order_status` int(11) NOT NULL DEFAULT '0' COMMENT '0=waiting,1=admin cancel,2=member cancel,3=delivered,4=success',
  `order_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่สร้างรายการ',
  `order_address` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'ที่อยู่จัดส่ง',
  `order_district` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ตำบล',
  `order_amphur` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อำเภอ',
  `order_province` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'จังหวัด',
  `order_zipcode` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รหัสไปรษณีย์',
  `order_freight` float NOT NULL COMMENT 'ค่าขนส่งสินค้ารวม',
  `order_detail` text COLLATE utf8_unicode_ci COMMENT 'รายละเอียดเพิ่มเติม',
  `order_type_buy` int(2) NOT NULL DEFAULT '0' COMMENT '0=ธรรมดา,1=e-wallet,2=ซื้อโดยแอดมิน,3=ewalletโดยแอดมิน',
  `order_track_name` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'บริษัทขนส่ง',
  `order_track_id` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'เลขติดตามพัสดุ',
  `order_cut_report` int(11) NOT NULL DEFAULT '0' COMMENT 'ตัดรายงานการสั่งซื้อ'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `system_order` (`order_id`, `order_code`, `order_member`, `order_buyer_id`, `order_buyer`, `order_buyer_tel`, `order_buyer_email`, `order_amount`, `order_price`, `order_point`, `order_status`, `order_create`, `order_address`, `order_district`, `order_amphur`, `order_province`, `order_zipcode`, `order_freight`, `order_detail`, `order_type_buy`, `order_track_name`, `order_track_id`, `order_cut_report`) VALUES
(1, 'ORDER-0000001', 1, 0, 'member', '0996932072', NULL, 1, 3500, 3300, 4, '2022-05-06 11:21:40', '', '', '', '', '', 0, '', 2, NULL, NULL, 1),
(2, 'ORDER-0000002', 2, 0, 'น้ำใส', '0996932089', NULL, 1, 3500, 3300, 4, '2022-05-06 11:21:57', '', '', '', '', '', 0, '', 2, NULL, NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `system_order_detail`
--

CREATE TABLE `system_order_detail` (
  `order_detail_id` int(11) NOT NULL,
  `order_detail_order` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `order_detail_product` int(11) NOT NULL,
  `order_detail_amount` int(11) NOT NULL,
  `order_detail_price` float NOT NULL,
  `order_detail_point` float NOT NULL,
  `order_detail_freight` float NOT NULL DEFAULT '0',
  `order_detail_review` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `system_order_detail`
--

INSERT INTO `system_order_detail` (`order_detail_id`, `order_detail_order`, `order_detail_product`, `order_detail_amount`, `order_detail_price`, `order_detail_point`, `order_detail_freight`, `order_detail_review`) VALUES
(1, '1', 1, 1, 3500, 3300, 0, 0),
(2, '2', 1, 1, 3500, 3300, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `system_package`
--

CREATE TABLE `system_package` (
  `package_id` int(11) NOT NULL,
  `package_main` int(11) NOT NULL DEFAULT '0',
  `package_product` int(11) NOT NULL DEFAULT '0',
  `package_name` varchar(100) DEFAULT NULL,
  `package_point` float NOT NULL DEFAULT '0',
  `package_price` float NOT NULL,
  `package_quantity` int(11) NOT NULL,
  `package_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_pay_refer`
--

CREATE TABLE `system_pay_refer` (
  `pay_id` int(11) NOT NULL,
  `pay_title` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'หัวข้อการโอน',
  `pay_member` int(11) NOT NULL COMMENT 'ไอดีสมาชิกที่โอน',
  `pay_buyer` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ชื่อผู้ซื้อหน้าเว็บเพจ',
  `pay_order` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีคำสั่งซื้อ',
  `pay_bank` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'โอนมาที่บัญชีธนาคาร',
  `pay_money` float NOT NULL COMMENT 'จำนวนเงินโอน',
  `pay_date` date DEFAULT NULL COMMENT 'วันที่ในสลิป',
  `pay_time` time DEFAULT NULL COMMENT 'เวลาในสลิป',
  `pay_image` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รูปใบเสร็จ',
  `pay_detail` text COLLATE utf8_unicode_ci COMMENT 'ข้อมูลเพิ่มเติม',
  `pay_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=จ่ายค่าสินค้า,1=จ่ายค่าสมัครสมาชิก',
  `pay_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=ปกติ,1=เสร็จสิ้น,2=ถูกยกเลิก',
  `pay_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่แจ้งการโอน'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `system_point` (
  ...
  `point_member` int(11) NOT NULL DEFAULT '0' COMMENT 'from member_id',
  `point_order` int(11) NOT NULL DEFAULT '0' COMMENT 'ไอดีหมายเลขคำสั่งซื้อ',
  `point_type` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0=รักษายอด,1=com,2=special',
  `point_bonus` float NOT NULL COMMENT 'point or pv',
  `point_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่ซื้อสินค้า',
  `point_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=default,1=cut',
  `point_detail` varchar(300) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `system_point` (`point_id`, `point_member`, `point_order`, `point_type`, `point_bonus`, `point_create`, `point_status`, `point_detail`) VALUES
(1, 1, 0, 0, 3300, '2022-05-06 11:21:40', 1, 'Buy Package'),
(2, 0, 1, 1, 165, '2022-05-06 11:21:40', 1, 'Get Referal bonus from 0000001'),
(3, 2, 0, 0, 3300, '2022-05-06 11:21:57', 1, 'Buy Package'),
(4, 1, 2, 1, 165, '2022-05-06 11:21:57', 1, 'Get Referal bonus from 0000002'),
(5, 1, 0, 2, 123.75, '2022-05-06 11:28:48', 0, 'Get commission 123.75 bath in round 40'),
(6, 1, 0, 3, 12.375, '2022-05-06 11:28:48', 0, 'Get Commission 12.375 bath from 0000002 '),
(7, 1, 0, 2, 123.75, '2022-05-06 11:31:41', 0, 'Get commission 123.75 bath in round 41'),
(8, 2, 0, 2, 123.75, '2022-05-06 11:31:41', 0, 'Get commission 123.75 bath in round 1'),
(9, 2, 0, 2, 123.75, '2022-05-06 11:39:59', 0, 'Get commission 123.75 bath in round 2'),
(10, 2, 0, 2, 123.75, '2022-05-06 11:54:04', 0, 'Get commission 123.75 bath in round 3'),
(11, 2, 0, 2, 123.75, '2022-05-06 11:54:13', 0, 'Get commission 123.75 bath in round 4'),
(12, 2, 0, 2, 123.75, '2022-05-06 11:54:23', 0, 'Get commission 123.75 bath in round 40'),
(13, 1, 0, 2, 13200, '2022-05-06 13:21:13', 0, 'Get commission 13200 bath in round 1'),
(14, 2, 0, 2, 123.75, '2022-05-06 13:21:13', 0, 'Get commission 123.75 bath in round 1'),
(15, 1, 0, 3, 12.375, '2022-05-06 13:21:13', 0, 'Get Commission 12.375 bath from 0000002 '),
(16, 2, 0, 2, 123.75, '2022-05-06 13:25:11', 0, 'Get commission 123.75 bath in round 1'),
(17, 1, 0, 3, 12.375, '2022-05-06 13:25:11', 0, 'Get Commission 12.375 bath from 0000002 '),
(18, 2, 0, 2, 123.75, '2022-05-06 13:28:13', 0, 'Get commission 123.75 bath in round 2'),
(19, 1, 0, 3, 12.375, '2022-05-06 13:28:13', 0, 'Get Commission 12.375 bath from 0000002 '),
(20, 2, 0, 2, 123.75, '2022-05-06 14:05:56', 0, 'Get commission 123.75 bath in round 1'),
(21, 1, 0, 3, 12.375, '2022-05-06 14:05:56', 0, 'Get Commission 12.375 bath from 0000002 '),
(22, 2, 0, 2, 123.75, '2022-05-06 14:13:56', 0, 'Get commission 123.75 bath in round 40'),
(23, 2, 0, 2, 13200, '2022-05-06 14:15:19', 0, 'Get commission 13200 bath in round 19'),
(24, 1, 0, 3, 1320, '2022-05-06 14:15:19', 0, 'Get Commission 1320 bath from 0000002 '),
(25, 2, 0, 2, 123.75, '2022-05-06 14:16:18', 0, 'Get commission 123.75 bath in round 1'),
(26, 1, 0, 3, 12.375, '2022-05-06 14:16:18', 0, 'Get Commission 12.375 bath from 0000002 '),
(27, 2, 0, 2, 123.75, '2022-05-06 14:16:30', 0, 'Get commission 123.75 bath in round 19'),
(28, 1, 0, 3, 12.375, '2022-05-06 14:16:30', 0, 'Get Commission 12.375 bath from 0000002 '),
(29, 2, 0, 2, 123.75, '2022-05-06 14:16:36', 0, 'Get commission 123.75 bath in round 20'),
(30, 1, 0, 3, 12.375, '2022-05-06 14:16:36', 0, 'Get Commission 12.375 bath from 0000002 '),
(31, 2, 0, 2, 123.75, '2022-05-06 14:16:41', 0, 'Get commission 123.75 bath in round 21'),
(32, 2, 0, 2, 123.75, '2022-05-06 14:20:14', 0, 'Get commission 123.75 bath in round 11'),
(33, 1, 0, 3, 12.375, '2022-05-06 14:20:14', 0, 'Get Commission 12.375 bath from 0000002 '),
(34, 1, 0, 2, 123.75, '2022-05-06 14:20:24', 0, 'Get commission 123.75 bath in round 1'),
(35, 2, 0, 2, 123.75, '2022-05-06 14:20:24', 0, 'Get commission 123.75 bath in round 12'),
(36, 1, 0, 3, 12.375, '2022-05-06 14:20:24', 0, 'Get Commission 12.375 bath from 0000002 '),
(37, 1, 0, 2, 123.75, '2022-05-06 14:20:40', 0, 'Get commission 123.75 bath in round 40'),
(38, 2, 0, 2, 123.75, '2022-05-06 14:20:40', 0, 'Get commission 123.75 bath in round 13'),
(39, 1, 0, 3, 12.375, '2022-05-06 14:20:40', 0, 'Get Commission 12.375 bath from 0000002 '),
(40, 1, 0, 2, 123.75, '2022-05-06 14:22:54', 0, 'Get commission 123.75 bath in round 1'),
(41, 2, 0, 2, 123.75, '2022-05-06 14:22:54', 0, 'Get commission 123.75 bath in round 14'),
(42, 1, 0, 3, 12.375, '2022-05-06 14:22:54', 0, 'Get Commission 12.375 bath from 0000002 '),
(43, 1, 0, 2, 123.75, '2022-05-06 14:23:17', 0, 'Get commission 123.75 bath in round 40'),
(44, 2, 0, 2, 123.75, '2022-05-06 14:23:17', 0, 'Get commission 123.75 bath in round 15'),
(45, 1, 0, 3, 12.375, '2022-05-06 14:23:17', 0, 'Get Commission 12.375 bath from 0000002 ');
...
CREATE TABLE `system_product` (
  ...
  `product_type` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'ประเภทสินค้า',
  `product_type2` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'ประเภทพิเศษ',
  `product_name` varchar(300) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อสินค้า',
  `product_detail` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'รายละเอียดสินค้า',
  `product_price` float NOT NULL DEFAULT '0' COMMENT 'ราคาหน้าเว็บเพจ',
  `product_price_member` float DEFAULT '0' COMMENT 'ราคาในหน้าหลังบ้าน',
  `product_point` float NOT NULL DEFAULT '0' COMMENT 'คะแนนสินค้า',
  `product_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสสินค้า',
  `product_freight` int(5) NOT NULL DEFAULT '0' COMMENT 'ค่าขนส่ง',
  `product_weight` float NOT NULL DEFAULT '0' COMMENT 'น้ำหนักสินค้า',
  `product_unit` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `product_group` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `product_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่เพิ่มข้อมูล',
  `product_amount` int(5) NOT NULL DEFAULT '0' COMMENT 'จำนวนสินค้า',
  `product_image_cover` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปปกสินค้า',
  `product_image_1` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปสินค้า',
  `product_image_2` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปสินค้า',
  `product_image_3` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปสินค้า',
  `product_image_4` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปสินค้า',
  `product_image_5` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รูปสินค้า'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `system_product` (`product_id`, `product_type`, `product_type2`, `product_name`, `product_detail`, `product_price`, `product_price_member`, `product_point`, `product_code`, `product_freight`, `product_weight`, `product_unit`, `product_group`, `product_create`, `product_amount`, `product_image_cover`, `product_image_1`, `product_image_2`, `product_image_3`, `product_image_4`, `product_image_5`) VALUES
(1, 1, 0, '100 $', '', 0, 3500, 3300, 'A-001', 0, 0, NULL, NULL, '2022-05-06 11:15:37', 0, '', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `system_product_amount`
--

CREATE TABLE `system_product_amount` (
  `product_amount_id` int(7) NOT NULL,
  `product_amount_product` int(7) NOT NULL COMMENT 'ไอดีสินค้า',
  `product_amount_old` int(7) NOT NULL COMMENT 'จำนวนคงเหลือก่อนเติม',
  `product_amount_new` int(7) NOT NULL COMMENT 'จำนวนสินค้าที่เติม',
  `product_amount_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่เติมสินค้า'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_product_amount`
--

INSERT INTO `system_product_amount` (`product_amount_id`, `product_amount_product`, `product_amount_old`, `product_amount_new`, `product_amount_create`) VALUES
(1, 1, 0, 0, '2022-05-06 11:15:37');

-- --------------------------------------------------------

--
-- Table structure for table `system_product_type`
--

CREATE TABLE `system_product_type` (
  `product_type_id` int(4) NOT NULL,
  `product_type_code` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `product_type_name` varchar(250) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `system_product_type`
--

INSERT INTO `system_product_type` (`product_type_id`, `product_type_code`, `product_type_name`) VALUES
(1, 'A', 'Normal');

-- --------------------------------------------------------

--
-- Table structure for table `system_provinces`
--

CREATE TABLE `system_provinces` (
...
--
-- Dumping data for table `system_provinces`
--

INSERT INTO `system_provinces` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
CREATE TABLE `system_report` (
  ...
  `report_point` float NOT NULL,
  `report_count` int(11) NOT NULL DEFAULT '0',
  `report_round` int(11) NOT NULL,
  `report_type` int(11) DEFAULT '0' COMMENT '0=default,1=sold,2=withdraw'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `system_report` (`report_id`, `report_create`, `report_point`, `report_count`, `report_round`, `report_type`) VALUES
(1, '2022-05-04 17:00:00', 0, 0, 1, 0),
(2, '2022-05-06 11:28:48', 7000, 2, 1, 1),
(3, '2022-05-05 17:00:00', 0, 0, 1, 2),
(4, '2022-05-06 11:31:41', 0, 0, 2, 1),
(5, '2022-05-05 17:00:00', 0, 0, 2, 2),
(6, '2022-05-06 11:39:59', 0, 0, 3, 1),
(7, '2022-05-05 17:00:00', 0, 0, 3, 2),
(8, '2022-05-06 11:54:04', 0, 0, 4, 1),
(9, '2022-05-05 17:00:00', 0, 0, 4, 2),
(10, '2022-05-06 11:54:13', 0, 0, 5, 1),
(11, '2022-05-05 17:00:00', 0, 0, 5, 2),
(12, '2022-05-06 11:54:23', 0, 0, 6, 1),
(13, '2022-05-05 17:00:00', 0, 0, 6, 2),
(14, '2022-05-06 13:12:13', 0, 0, 7, 1),
(15, '2022-05-05 17:00:00', 0, 0, 7, 2),
(16, '2022-05-06 13:14:16', 0, 0, 8, 1),
(17, '2022-05-05 17:00:00', 0, 0, 8, 2),
(18, '2022-05-06 13:17:00', 0, 0, 9, 1),
(19, '2022-05-05 17:00:00', 0, 0, 9, 2),
(20, '2022-05-06 13:17:38', 0, 0, 10, 1),
(21, '2022-05-05 17:00:00', 0, 0, 10, 2),
(22, '2022-05-06 13:18:21', 0, 0, 11, 1),
(23, '2022-05-05 17:00:00', 0, 0, 11, 2),
(24, '2022-05-06 13:18:27', 0, 0, 12, 1),
(25, '2022-05-05 17:00:00', 0, 0, 12, 2),
(26, '2022-05-06 13:21:13', 0, 0, 13, 1),
(27, '2022-05-05 17:00:00', 0, 0, 13, 2),
(28, '2022-05-06 13:25:11', 0, 0, 14, 1),
(29, '2022-05-05 17:00:00', 0, 0, 14, 2),
(30, '2022-05-06 13:28:13', 0, 0, 15, 1),
(31, '2022-05-05 17:00:00', 0, 0, 15, 2),
(32, '2022-05-06 14:05:31', 0, 0, 16, 1),
(33, '2022-05-05 17:00:00', 0, 0, 16, 2),
(34, '2022-05-06 14:05:43', 0, 0, 17, 1),
(35, '2022-05-05 17:00:00', 0, 0, 17, 2),
(36, '2022-05-06 14:05:56', 0, 0, 18, 1),
(37, '2022-05-05 17:00:00', 0, 0, 18, 2),
(38, '2022-05-06 14:13:56', 0, 0, 19, 1),
(39, '2022-05-05 17:00:00', 0, 0, 19, 2),
(40, '2022-05-06 14:14:35', 0, 0, 20, 1),
(41, '2022-05-05 17:00:00', 0, 0, 20, 2),
(42, '2022-05-06 14:15:19', 0, 0, 21, 1),
(43, '2022-05-05 17:00:00', 0, 0, 21, 2),
(44, '2022-05-06 14:16:18', 0, 0, 22, 1),
(45, '2022-05-05 17:00:00', 0, 0, 22, 2),
(46, '2022-05-06 14:16:30', 0, 0, 23, 1),
(47, '2022-05-05 17:00:00', 0, 0, 23, 2),
(48, '2022-05-06 14:16:36', 0, 0, 24, 1),
(49, '2022-05-05 17:00:00', 0, 0, 24, 2),
(50, '2022-05-06 14:16:41', 0, 0, 25, 1),
(51, '2022-05-05 17:00:00', 0, 0, 25, 2),
(52, '2022-05-06 14:17:01', 0, 0, 26, 1),
(53, '2022-05-05 17:00:00', 0, 0, 26, 2),
(54, '2022-05-06 14:19:59', 0, 0, 27, 1),
(55, '2022-05-05 17:00:00', 0, 0, 27, 2),
(56, '2022-05-06 14:20:14', 0, 0, 28, 1),
(57, '2022-05-05 17:00:00', 0, 0, 28, 2),
(58, '2022-05-06 14:20:24', 0, 0, 29, 1),
(59, '2022-05-05 17:00:00', 0, 0, 29, 2),
(60, '2022-05-06 14:20:40', 0, 0, 30, 1),
(61, '2022-05-05 17:00:00', 0, 0, 30, 2),
(62, '2022-05-06 14:22:54', 0, 0, 31, 1),
(63, '2022-05-05 17:00:00', 0, 0, 31, 2),
(64, '2022-05-06 14:23:17', 0, 0, 32, 1),
(65, '2022-05-05 17:00:00', 0, 0, 32, 2);

-- --------------------------------------------------------

--
-- Table structure for table `system_report_detail`
--

CREATE TABLE `system_report_detail` (
  `report_detail_id` int(11) NOT NULL,
  `report_detail_main` int(3) NOT NULL,
  `report_detail_link` int(11) NOT NULL DEFAULT '0',
  `report_detail_point` float NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `system_report_detail`
--

INSERT INTO `system_report_detail` (`report_detail_id`, `report_detail_main`, `report_detail_link`, `report_detail_point`) VALUES
(1, 2, 1, 3500),
(2, 2, 2, 3500);
...
CREATE TABLE `system_theme` (
  `theme_mode` varchar(30) DEFAULT NULL,
  `theme_header` varchar(30) DEFAULT NULL,
  `theme_sidebar` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `system_thread`
--

CREATE TABLE `system_thread` (
  `thread_id` int(11) NOT NULL,
  `thread_title` varchar(150) NOT NULL,
  `thread_intro` varchar(300) DEFAULT NULL,
  `thread_type` int(11) NOT NULL DEFAULT '0',
  `thread_detail` text,
  `thread_image` varchar(100) DEFAULT NULL,
  `thread_highlight` int(11) DEFAULT '0' COMMENT '0=no,1=yes',
  `thread_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_thread_type`
--

CREATE TABLE `system_thread_type` (
  `thread_type_id` int(11) NOT NULL,
  `thread_type_name` varchar(150) NOT NULL,
  `thread_type_count` int(11) NOT NULL DEFAULT '0',
  `thread_type_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_tranfer`
--

CREATE TABLE `system_tranfer` (
  `tranfer_id` int(11) NOT NULL,
  `tranfer_member` int(11) NOT NULL,
  `tranfer_to` int(11) NOT NULL,
  `tranfer_money` int(11) NOT NULL,
  `tranfer_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `system_visitor`
--

CREATE TABLE `system_visitor` (
  `visitor_id` int(11) NOT NULL,
  `visitor_code` varchar(50) DEFAULT NULL,
  `visitor_name` varchar(50) NOT NULL,
  `visitor_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `visitor_email` varchar(50) DEFAULT NULL,
  `visitor_tel` varchar(10) DEFAULT NULL,
  `visitor_cover_image` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_visitor`
--

INSERT INTO `system_visitor` (`visitor_id`, `visitor_code`, `visitor_name`, `visitor_create`, `visitor_email`, `visitor_tel`, `visitor_cover_image`) VALUES
(4, '2563666913677704', 'Nathasophon Khamdechsak', '2022-02-01 08:59:00', 'jameschelsea30108@hotmail.com', NULL, 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2563666913677704');

-- --------------------------------------------------------

--
-- Table structure for table `system_withdraw`
--

CREATE TABLE `system_withdraw` (
  `withdraw_id` int(11) NOT NULL,
  `withdraw_member` int(11) NOT NULL,
  `withdraw_point` float NOT NULL,
  `withdraw_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=waiting,1=sucess, 2=cancel',
  `withdraw_cut` int(11) NOT NULL DEFAULT '0' COMMENT '0=default,1=cut',
  `withdraw_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `system_zipcodes`
--
...
--
-- Dumping data for table `system_zipcodes`
--

INSERT INTO `system_zipcodes` (`id`, `district_code`, `zipcode`) VALUES
(1, '100101', '10200'),
(2, '100102', '10200'),
(3, '100103', '10200'),
(4, '100104', '10200'),
...
--
-- Indexes for table `system_amphures`
--
ALTER TABLE `system_amphures`
...
--
-- Indexes for table `system_buyer`
--
ALTER TABLE `system_buyer`
  ADD PRIMARY KEY (`buyer_id`);

--
-- Indexes for table `system_cart`
--
ALTER TABLE `system_cart`
  ADD PRIMARY KEY (`cart_id`),
  ADD KEY `f_id` (`cart_product_id`);

--
-- Indexes for table `system_class`
--
ALTER TABLE `system_class`
  ADD PRIMARY KEY (`class_id`),
  ADD UNIQUE KEY `class_id_3` (`class_id`),
  ADD KEY `class_id` (`class_id`),
  ADD KEY `class_id_2` (`class_id`),
  ADD KEY `class_id_4` (`class_id`),
  ADD KEY `class_image` (`class_image`),
  ADD KEY `class_image_2` (`class_image`);
ALTER TABLE `system_class` ADD FULLTEXT KEY `class_image_3` (`class_image`);
ALTER TABLE `system_class` ADD FULLTEXT KEY `class_image_4` (`class_image`);

--
-- Indexes for table `system_comment`
--
ALTER TABLE `system_comment`
  ADD PRIMARY KEY (`comment_id`);

--
-- Indexes for table `system_commission`
--
ALTER TABLE `system_commission`
...
--
-- Indexes for table `system_deposit`
--
ALTER TABLE `system_deposit`
  ADD PRIMARY KEY (`deposit_id`);

--
-- Indexes for table `system_districts`
--
ALTER TABLE `system_districts`
  ADD PRIMARY KEY (`DISTRICT_ID`);

--
-- Indexes for table `system_liner`
--
ALTER TABLE `system_liner`
  ADD PRIMARY KEY (`liner_id`),
  ADD KEY `sli_sr_target` (`liner_member`,`liner_direct`);

--
-- Indexes for table `system_liner2`
--
ALTER TABLE `system_liner2`
  ADD PRIMARY KEY (`liner2_id`);
...
--
-- Indexes for table `system_log_payment`
--
ALTER TABLE `system_log_payment`
  ADD PRIMARY KEY (`payment_id`);

--
-- Indexes for table `system_log_withdraw`
--
ALTER TABLE `system_log_withdraw`
  ADD PRIMARY KEY (`logwd_id`);

--
-- Indexes for table `system_member`
--
...
--
-- Indexes for table `system_order`
--
ALTER TABLE `system_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `system_order_detail`
--
ALTER TABLE `system_order_detail`
  ADD PRIMARY KEY (`order_detail_id`);

--
-- Indexes for table `system_package`
--
ALTER TABLE `system_package`
  ADD PRIMARY KEY (`package_id`);

--
-- Indexes for table `system_pay_refer`
--
ALTER TABLE `system_pay_refer`
  ADD PRIMARY KEY (`pay_id`),
  ADD KEY `sf_sm_id` (`pay_member`);

--
-- Indexes for table `system_point`
--
ALTER TABLE `system_point`
  ADD PRIMARY KEY (`point_id`),
  ADD KEY `sli_id` (`point_member`);
...
ALTER TABLE `system_product`
  ...
  ADD KEY `spd_sc_id` (`product_type`),
  ADD KEY `product_code` (`product_code`);

--
-- Indexes for table `system_product_amount`
--
ALTER TABLE `system_product_amount`
  ADD PRIMARY KEY (`product_amount_id`);

--
-- Indexes for table `system_product_type`
--
ALTER TABLE `system_product_type`
  ADD PRIMARY KEY (`product_type_id`);

--
-- Indexes for table `system_provinces`
--
ALTER TABLE `system_provinces`
...
--
-- Indexes for table `system_report_detail`
--
ALTER TABLE `system_report_detail`
  ADD PRIMARY KEY (`report_detail_id`),
  ADD KEY `sbl_id` (`report_detail_main`,`report_detail_link`);

--
-- Indexes for table `system_thread`
--
ALTER TABLE `system_thread`
  ADD PRIMARY KEY (`thread_id`);

--
-- Indexes for table `system_thread_type`
--
ALTER TABLE `system_thread_type`
  ADD PRIMARY KEY (`thread_type_id`);

--
-- Indexes for table `system_tranfer`
--
ALTER TABLE `system_tranfer`
  ADD PRIMARY KEY (`tranfer_id`);

--
-- Indexes for table `system_visitor`
--
ALTER TABLE `system_visitor`
  ADD PRIMARY KEY (`visitor_id`);

--
-- Indexes for table `system_withdraw`
--
ALTER TABLE `system_withdraw`
  ADD PRIMARY KEY (`withdraw_id`);

--
-- Indexes for table `system_zipcodes`
--
ALTER TABLE `system_zipcodes`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `system_admin`
  MODIFY `admin_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `system_amphures`
--
ALTER TABLE `system_amphures`
  MODIFY `AMPHUR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=999;
--
...
--
-- AUTO_INCREMENT for table `system_buyer`
--
ALTER TABLE `system_buyer`
...
--
ALTER TABLE `system_cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี', AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `system_comment`
--
ALTER TABLE `system_comment`
  MODIFY `comment_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_commission`
--
ALTER TABLE `system_commission`
  MODIFY `commission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `system_contact`
  MODIFY `contact_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี';
--
-- AUTO_INCREMENT for table `system_deposit`
--
ALTER TABLE `system_deposit`
  MODIFY `deposit_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี';
--
-- AUTO_INCREMENT for table `system_districts`
--
ALTER TABLE `system_districts`
  MODIFY `DISTRICT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8861;
--
-- AUTO_INCREMENT for table `system_liner`
--
ALTER TABLE `system_liner`
  MODIFY `liner_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `system_liner2`
--
ALTER TABLE `system_liner2`
  MODIFY `liner2_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี';
--
...
--
-- AUTO_INCREMENT for table `system_log_payment`
--
ALTER TABLE `system_log_payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_log_withdraw`
--
ALTER TABLE `system_log_withdraw`
  MODIFY `logwd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `system_member`
--
ALTER TABLE `system_member`
  MODIFY `member_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `system_pay_refer`
--
ALTER TABLE `system_pay_refer`
...
--
-- AUTO_INCREMENT for table `system_product_amount`
--
ALTER TABLE `system_product_amount`
  MODIFY `product_amount_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `system_product_type`
--
ALTER TABLE `system_product_type`
  MODIFY `product_type_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `system_provinces`
--
ALTER TABLE `system_provinces`
...
--
ALTER TABLE `system_report`
  MODIFY `report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
-- AUTO_INCREMENT for table `system_report_detail`
--
ALTER TABLE `system_report_detail`
  MODIFY `report_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `system_thread`
--
ALTER TABLE `system_thread`
  MODIFY `thread_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_thread_type`
--
ALTER TABLE `system_thread_type`
  MODIFY `thread_type_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_tranfer`
--
ALTER TABLE `system_tranfer`
  MODIFY `tranfer_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_visitor`
--
ALTER TABLE `system_visitor`
  MODIFY `visitor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `system_withdraw`
--
ALTER TABLE `system_withdraw`
  MODIFY `withdraw_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `system_zipcodes`
--
ALTER TABLE `system_zipcodes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7456;
