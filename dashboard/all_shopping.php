                ...
                <div class="col-12 col-sm-3 product-grid">
                    <div class="card p-0">
                        ...
                        <div class="p-3">
                            ...
                            <div class="d-flex">
                                <a href="<?php echo $cart_url ?>" class="btn btn-success btn-sm me-1 ms-auto"><?php echo $l_cart_insert ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="<?php echo $page_type ?>" method="get" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <select class="form-select" name="product_type2" required>
                        <option value="0" selected>รักษาสถานะ (ปกติ)</option>
                        <option value="1">เปิดรหัส (พิเศษ)</option>
                    </select>
                </div>
                <div class="col-12">
...
<?php } elseif (isset($_GET['action']) && $_GET['action'] == 'cart_setting') {
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo $page_type ?>?page=shopping"><?php echo $l_buy ?></a></li>
    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-1 pt-3 pb-3 p-sm-5">
            ...
            <div class="d-flex">
                <a href="<?php echo $checkbill_url ?>" class="<?php echo $checkbill_class ?>"><?php echo $l_checkbill ?></a>
            </div>
        </div>
    </div>
    <script>
        ...
        <div class="card-body p-3 p-sm-3">
            ...
            <div class="card p-3 position-relative border border-1 border-success">
                <form action="process/setting_buy.php" method="post" class="row" enctype="multipart/form-data">
                    ...
                    $ewallet_dis  = $member_ewallet < $order_price + $order_freight ? "disabled" : false;
                    $ewallet_name = $member_ewallet < $order_price + $order_freight ? "E-Wallet *Money not enough" : "E-Wallet";
                        ...
                        <div class="row g-3">
                            ...
                            <?php if ($system_delivery == 1) { ?>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="order_district" value="<?php echo $address_district ?>" required>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="form-label"><?php echo $l_amphures ?></label>
                                    <input type="text" class="form-control" name="order_amphur" value="<?php echo $address_amphure ?>" required>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="form-label"><?php echo $l_provinces ?></label>
                                    <input type="text" class="form-control" name="order_province" value="<?php echo $address_province ?>" required>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="form-label"><?php echo $l_zipcode ?></label>
                                    <input type="text" class="form-control" name="order_zipcode" value="<?php echo $address_zipcode ?>" required>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                        ...
                        <textarea name="order_detail" class="form-control" rows="<?php echo $detail_row ?>" placeholder="<?php echo $l_other ?>"></textarea>
                    </div>
