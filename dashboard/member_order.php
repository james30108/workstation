                            ...
                            <td>
                                ...
                                elseif ($order_type_buy == 4) { 
                                    ...
                                    if ($order_status == 0) { 
                                        ...
                                        $pay_url = "$page_type?page=shopping&action=payment&order_id=$order_id";
                                        ?>

                                        <a href="<?php echo $pay_url ?>" target="_blank"><font color=blue><?php echo $l_order_pay4 ?></font></a>

                                    <?php } else { 

                                        echo "<font color=blue>$l_order_pay4</font>";
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center mx-auto">
                                    <?php if ($order_status == 0) { echo $l_order_status0; ?>
                                        ...
                                        <hr class="vr mx-1">
                                        <a href="<?php echo $cancel_url ?>" onclick="javascript:return confirm('Cancel ?')" title="Cancel"><i class="bx bx-trash mx-1 font-22 text-danger"></i></a>
