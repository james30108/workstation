				...
				<ul class="metismenu" id="menu">
					...
					<?php if ($admin_status != 2 && $admin_status != 3) { ?>
						<li>
							...
							<ul>
								<li><a href="admin.php?page=admin_product"><i class="bx bx-right-arrow-alt"></i><?php echo $l_package ?></a></li>
								<li><a href="admin.php?page=admin_product_type"><i class="bx bx-right-arrow-alt"></i><?php echo $lang == 0 ? "ประเภทแพ็กเกจ" : "Package Type" ?></a></li>
							</ul>
						</li>
					<?php } ?>
					<li>
