...
if     (isset($_POST['action']) && $_POST['action'] == 'setting_config') {
    ...
    $report_type        = $_POST['1'] ? $_POST['1'] : $report_type;
    $report_fee1        = $_POST['2'] ? $_POST['2'] : $report_fee1;
    $report_min         = $_POST['3'] ? $_POST['3'] : $report_min;
    $report_max         = $_POST['4'] ? $_POST['4'] : $report_max;
    $report_fee2        = $_POST['5'] ? $_POST['5'] : $report_fee2;
    $downline_max       = $_POST['6'] ? $_POST['6'] : $downline_max;
    $com_ppm            = $_POST['7'] ? $_POST['7'] : $com_ppm;
    $com_number         = $_POST['8'] ? $_POST['8'] : $com_number;
    $com_style          = $_POST['9'] ? $_POST['9'] : $com_style;
    $system_style       = $_POST['10'] ? $_POST['10'] : $system_style;
    $system_switch      = $_POST['11'] ? $_POST['11'] : $system_switch;
    $system_lang        = $_POST['12'] ? $_POST['12'] : $system_lang;
    $system_liner       = $_POST['13'] ? $_POST['13'] : $system_liner;
    $system_webpage     = $_POST['14'] ? $_POST['14'] : $system_webpage;
    $system_buyer       = $_POST['15'] ? $_POST['15'] : $system_buyer;
    $system_mobile      = $_POST['16'] ? $_POST['16'] : $system_mobile;
    $system_class       = $_POST['17'] ? $_POST['17'] : $system_class;
    $system_admin_buy   = $_POST['18'] ? $_POST['18'] : $system_admin_buy;
    $system_ewallet     = $_POST['19'] ? $_POST['19'] : $system_ewallet;
    $system_member_expire= $_POST['20'] ? $_POST['20'] : $system_member_expire;
    $system_stock       = $_POST['21'] ? $_POST['21'] : $system_stock;
    $system_tracking    = $_POST['22'] ? $_POST['22'] : $system_tracking;
    $system_liner2      = $_POST['23'] ? $_POST['23'] : $system_liner2;
    $system_address     = $_POST['24'] ? $_POST['24'] : $system_address;
    $system_pay         = $_POST['25'] ? $_POST['25'] : $system_pay;
    $system_comment     = $_POST['26'] ? $_POST['26'] : $system_comment;
    $system_com_withdraw= $_POST['27'] ? $_POST['27'] : $system_com_withdraw;
    $report_style       = $_POST['28'] ? $_POST['28'] : $report_style;
    $system_product_type2= $_POST['29'] ? $_POST['29'] : $system_product_type2;
    $system_ecommerce   = $_POST['30'] ? $_POST['30'] : $system_ecommerce;
    $system_thread      = $_POST['31'] ? $_POST['31'] : $system_thread;
    $system_insertmember= $_POST['32'] ? $_POST['32'] : $system_insertmember;
